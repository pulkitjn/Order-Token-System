...
import OutletOTPValidator from "./OutletOTPValidator";
...
const OutletOTP = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const validationErrors = OutletOTPValidator(formData);
    ...
    const verifyEmailOtpAndRegister = async () => {
      try {
        const response = await axios.post("/outlets/register", formData);
